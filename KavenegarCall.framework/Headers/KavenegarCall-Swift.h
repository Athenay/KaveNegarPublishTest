...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KavenegarCall",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSStream;

SWIFT_CLASS("_TtC13KavenegarCall16FoundationStream")
...
SWIFT_CLASS("_TtC13KavenegarCall21PeerConnectionWrapper")
@interface PeerConnectionWrapper : NSObject
...
@interface PeerConnectionWrapper (SWIFT_EXTENSION(KavenegarCall)) <RTCPeerConnectionDelegate>
...
SWIFT_CLASS("_TtC13KavenegarCall9WebSocket")
